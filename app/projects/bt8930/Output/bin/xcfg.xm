...
config(LISTVAL, "USER_DEF键短按", "选择USER_DEF键短按的功能", USER_DEF_KS_SEL,    BIT, 8, 11, 15, ("无", 0), ("回拨", 1), ("SIRI", 2), ("PREV", 3), ("NEXT", 4), ("VOL+", 5), ("VOL-", 6), ("MODE", 7), ("HID拍照", 8), ("IOS HOME", 9), ("中英文切换", 10), ("PLAY/PAUSE", 11), ("CBT_TEST", 12), ("低延时", 13), ("降噪控制", 14));
config(LISTVAL, "USER_DEF键长按", "选择USER_DEF键长按的功能", USER_DEF_KL_SEL,    BIT, 8, 2, 15, ("无", 0), ("回拨", 1), ("SIRI", 2), ("PREV", 3), ("NEXT", 4), ("VOL+", 5), ("VOL-", 6), ("MODE", 7), ("HID拍照", 8), ("IOS HOME", 9), ("中英文切换", 10), ("PLAY/PAUSE", 11), ("CBT_TEST", 12), ("低延时", 13), ("降噪控制", 14));
config(LISTVAL, "USER_DEF键双击", "选择USER_DEF键双击的功能", USER_DEF_KD_SEL,    BIT, 8, 1, 15, ("无", 0), ("回拨", 1), ("SIRI", 2), ("PREV", 3), ("NEXT", 4), ("VOL+", 5), ("VOL-", 6), ("MODE", 7), ("HID拍照", 8), ("IOS HOME", 9), ("中英文切换", 10), ("PLAY/PAUSE", 11), ("CBT_TEST", 12), ("低延时", 13), ("降噪控制", 14));
config(LISTVAL, "USER_DEF键三击", "选择USER_DEF键三击的功能", USER_DEF_KT_SEL, 	  BIT, 8, 0, 15, ("无", 0), ("回拨", 1), ("SIRI", 2), ("PREV", 3), ("NEXT", 4), ("VOL+", 5), ("VOL-", 6), ("MODE", 7), ("HID拍照", 8), ("IOS HOME", 9), ("中英文切换", 10), ("PLAY/PAUSE", 11), ("CBT_TEST", 12), ("低延时", 13), ("降噪控制", 14));
config(LISTVAL, "USER_DEF键四击", "选择USER_DEF键四击的功能", USER_DEF_KFOUR_SEL, BIT, 8, 0, 15, ("无", 0), ("回拨", 1), ("SIRI", 2), ("PREV", 3), ("NEXT", 4), ("VOL+", 5), ("VOL-", 6), ("MODE", 7), ("HID拍照", 8), ("IOS HOME", 9), ("中英文切换", 10), ("PLAY/PAUSE", 11), ("CBT_TEST", 12), ("低延时", 13), ("降噪控制", 14));
config(LISTVAL, "USER_DEF键五击", "选择USER_DEF键五击的功能", USER_DEF_KFIVE_SEL, BIT, 8, 0, 15, ("无", 0), ("回拨", 1), ("SIRI", 2), ("PREV", 3), ("NEXT", 4), ("VOL+", 5), ("VOL-", 6), ("MODE", 7), ("HID拍照", 8), ("IOS HOME", 9), ("中英文切换", 10), ("PLAY/PAUSE", 11), ("CBT_TEST", 12), ("低延时", 13), ("降噪控制", 14));
...
config(CHECK,  "是否使能NTC的0.3C充电模式",  "是否使能NTC的0.3C充电模式",  NTC_0P3C_EN,  0);
config(BYTE,  "进入0.3C充电的温度",  "进入0.3C充电的温度",  NTC_0P3C_ENTER,  0, 255, 40,  NTC_0P3C_EN);
config(BYTE,  "退出0.3C充电的温度",  "退出0.3C充电的温度，需要高于进入的温度",  NTC_0P3C_EXIT,  0, 255, 50,  NTC_0P3C_EN);
config(LIST, "0.3C恒流充电电流", "0.3C恒流充电电流", NTC_0P3C_CONSTANT_CURR, 24, "5mA", "10mA", "15mA", "20mA", "25mA", "30mA", "35mA", "40mA", "45mA", "50mA", "55mA", "60mA", "65mA", "70mA", "85mA", "90mA", "105mA", "110mA", "125mA", "130mA", "145mA", "150mA", "165mA", "170mA", 2, NTC_0P3C_EN);
config(CHECK, "0.3C充电电压跟随模式", "0.3C是否打开充电电压跟随模式", NTC_0P3C_CHARGE_VOLTAGE_FOLLOW, 0, NTC_0P3C_EN);
config(LIST, "0.3C充电截止电流", "0.3C选择充电截止电流", NTC_0P3C_CHARGE_STOP_CURR, 8, "2.5mA", "5mA", "7.5mA", "10mA", "15mA", "20mA", "25mA", "30mA", 1, NTC_0P3C_EN);
config(LIST, "0.3C涓流充电电流", "0.3C涓流充电（电池电压小于2.9v）电流", NTC_0P3C_CHARGE_TRICKLE_CURR, 8, "5mA", "10mA", "15mA", "20mA", "25mA", "30mA", "35mA", "40mA", 0, NTC_0P3C_EN);


#config(SUB, "字典配置", "字典相关配置");
#config(TEXT,"SN_STR","SN码",SN_STR,32,"bdffe974b5000000");
#config(MAC,"BT_ADDR","蓝牙地址",BT_ADDR_DICT,6,41:42:00:00:00:00,41:42:FF:FF:FF:FF,41:42:00:00:00:01);
