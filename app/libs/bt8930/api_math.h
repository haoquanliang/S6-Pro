...
#define clkgat_hwmath_en()      cpu_set_sfr((psfr_t)&CLKGAT2, BIT(29))  //开启hwmath_clk
#define clkgat_hwmath_dis()     cpu_clr_sfr((psfr_t)&CLKGAT2, BIT(29))
#define clkgat_plc_en()         cpu_set_sfr((psfr_t)&CLKGAT2, BIT(20))  //PLC
#define clkgat_plc_dis()        cpu_clr_sfr((psfr_t)&CLKGAT2, BIT(20))
